        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body card_body">
                    <center>
                        <h2>Product Sales (By Barcode Device)</h2><br>
                    </center><br>
                    <div class="row">
    ...
    $('#codescan').codeScanner({
        onScan: function ($element, value) {
            ...
            if (value) {
                $.ajax({
                    type: 'GET',
                    url: '{{URL::to("get_product_information")}}',
                    data: {value: value},
                    async: false,
                    dataType: 'json',
                    success: function (data) {
                        if (data) {
                            ...
                            var tr = '<tr>' +
                                    ...
                                    '<td style="width: 35%;"><input type="hidden" name="productid[]" value="' + data.proid + '"><input type="text" class="form-control" name="proname[]" value="' + data.proname + '" style="border:1px solid #1e88e5;text-align: center;border-radius: 10px;" readonly=""></td>' +
