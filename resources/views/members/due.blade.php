            ...
            <div class="card">
                <div class="card-body card_body">
                    <div class="card-body">
                        ...
                        <div id="printarea">
                            <center>
                                <h4>Due Collection Information For <b><?= $getmembers->memberidno ?> <?= $getmembers->memberrank ?> <?= $getmembers->membername ?></b></h4><br>
                                <h4><i class="fa fa-money-bill-alt"></i> Total Due: <b><?= $DueAmount ?> BDT</b></h4>
                            </center>
                                ...
                                <table data-page-length='100' class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="table_header">
                                            ...
                                            <th style="text-align: center;color: #000">Due Amount</th>
                                        </tr>
                                    </thead>
