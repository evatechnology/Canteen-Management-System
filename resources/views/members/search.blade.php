                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="memberidno" class="form-control" style="border-radius:10px;border:1px solid #1e88e5;" id="memberidno" readonly=""> 
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label>Rank</label><br>
            ...
            if (value === "edit") {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#memberidno').val(data.memberidno);
